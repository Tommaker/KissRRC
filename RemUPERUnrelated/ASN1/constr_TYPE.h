 ...
 * dynamically.)
 */
// ASN.1 decoder and encoder use custom memory interface, no need free memory by itself.
#if 0
...
#else
#define ATF_NOFLAGS     0x0
#define ATF_POINTER     0x01 /* Represented by the pointer */
#define ATF_OPEN_TYPE   0x02  /* ANY type, without meaningful tag */
typedef uint8_t asn_TYPE_flags_e;
#endif
typedef struct asn_TYPE_member_s {
	asn_TYPE_flags_e flags;	/* Element's presentation flags */
    /* ECM9100-1765 Compress data type to small size. */
//	int optional;	/* Following optional members, including current */
//	int memb_offset;		/* Offset of the element */
	uint8_t optional;	/* Following optional members, including current */
	short memb_offset;		/* Offset of the element */
